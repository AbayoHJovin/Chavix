...
const Navbar: React.FC<NavbarProps> = ({ user }) => {
  ...
  return (
    <nav className="bg-gray-800  inset-x-0 top-0 z-10">
            ...
            <div className="hidden sm:block sm:ml-6">
              <div className="flex space-x-4">
                ...
                <h1
                  ...
                  className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm cursor-pointer font-medium"
                >
                  DMs
                </h1>
                <h1
